...
Since June 2020, I have also been working as a freelance web developer, work as in WordPress website design. I have worked various projects, including creating a program for automate stock management of a computer store that involves receiving and modifying Excel files and upload into e-commerce platform eg: shoppee.`
  ...
  projectExamples: {
    ...
    response: [
      `Sure! Here are some examples of projects I've worked on:<br><br><b>Software Engineer at Refinitiv, LSEG business</b><br><br>1. FXForward<br>Website: <a href='/work?projects=fxforwards'>https://soravit-varanich.com/work?projects=fxforwards</a><br>Description: FXForward is a platform in Refinitiv that consists of derivative contracts allowing participants to exchange currencies at a predetermined rate on a future date. These contracts are used for hedging or speculating on currency movements. As a Software Engineer in the FXForward team, I utilized Angular 8 and RxJs for state management, Angular web socket for real-time updates, and Git for version control. My main responsibilities included developing new features and performing maintenance tasks based on Jira tickets.<br><br>2. MUNI<br>Description: MUNI is a platform in Refinitiv that consists of debt securities issued by state and local governments to fund public projects, providing investors with fixed income while supporting community development. As a Software Engineer, I primarily worked with AngularJs for maintenance and bug fixes. My responsibilities included performing maintenance tasks based on Jira tickets.<br><br>3. Particle app proxy<br>Description: Particle app proxy is a server-side application platform built with Node.js and Express.js. It utilizes service workers to create a localhost environment on a real domain, acting as a proxy for the application. This approach resolves Cross-Origin Resource Sharing (CORS) issues that developers in my department often encounter when connecting to real API domains from localhost. Moreover, it intercepts requests from the backend, substituting mockup data JSON when a registered request matches, thereby facilitating smooth testing and development processes.<br><b>My main responsibilities:</b><br>1. I developed client sides to allow developers to register service workers on their application (Angular 14 and RxJs).<br>2. I developed server-side to serve their application static folder, and I had to mimic the real behavior from AWS Cloud when serving static folders to the real domain (Node.js and Express.js).<br><br><b>During my university studies:</b><br><br>SIIT Gate (Graduation Project)<br>Website: <a href='https://soravit-varanich.web.app/siitgate'>https://soravit-varanich.web.app/siitgate</a><br>Description: This application was developed using React Native and Expo CLI. It was my senior project during my last year of university. The app allows students to view their lecture notes and grades for each subject.<br><br>Mercuryt-shirts Website<br>Website: <a href='https://mercuryt-shirt.web.app'>https://mercuryt-shirt.web.app</a><br>Description: This is a freelance project for a t-shirt store. The website showcases store information and allows customers to place orders. It was developed using React.js, Material UI, and hosted on Firebase.<br><br>Anti Covid (University Project)<br>Website: <a href='https://soravit-varanich.web.app/anticovid'>https://soravit-varanich.web.app/anticovid</a><br>Description: This project was part of my coursework for the ITS432 Mobile Application Programming course during my third year at Sirindhorn International Institute of Technology (SIIT), Thammasat University. I developed this application using React Native and Expo CLI. The app provides real-time information about the Covid-19 situation.`
    ]
  }
};
